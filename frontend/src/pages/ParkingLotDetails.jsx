...
// Assumes ~15 km/h average urban speed (accounts for traffic, lights, parking search).
// This is demo/approximation data — real driving time will require a routing API
// (Google Maps / Waze) connected in a future task.
